...
function handleGum(data: string, { output_format = 'kitty', theme, size, background }: { output_format: 'svg' | 'png' | 'kitty'; theme: ThemeName; size: number | Size, background: string }): string {
